...
import { StickyTableTheme, StickyTable, TableColumn } from "react-native-sticky-table";
    ...
    const columns: TableColumn<UserData>[] = [
        {
            ...
            sorter: (a: UserData, b: UserData) => parseInt(a.name.split(" ")[1]) - parseInt(b.name.split(" ")[1]),
        },
        {
            id: "email",
            label: "Email",
        ...
        },
        {
            ...
            width: 120,
            align: "center",
            sorter: (a: UserData, b: UserData) => a.status.localeCompare(b.status),
        },
        {
            id: "lastLogin",
            label: "Last Login",
